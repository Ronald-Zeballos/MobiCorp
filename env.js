...
export const config = {
  ...
  // Catálogo/negocio
  CATALOG_URL: process.env.CATALOG_URL, // fallback general
  CATALOG_URL_OFICINA: process.env.CATALOG_URL_OFICINA,
  CATALOG_URL_HOGAR: process.env.CATALOG_URL_HOGAR,
  CATALOG_URL_LOCAL: process.env.CATALOG_URL_LOCAL,
  CATALOG_URL_CONSULTORIO: process.env.CATALOG_URL_CONSULTORIO,
  CATALOG_URL_OTRO: process.env.CATALOG_URL_OTRO,
  ...
  // Google Sheets (si algún día lo usas)
